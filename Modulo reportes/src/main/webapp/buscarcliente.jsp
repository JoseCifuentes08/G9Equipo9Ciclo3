		...
		<div class="container">
			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					<span class="input-group-text" style="width: 170px;" id="basic-addon4">Cédula del cliente</span> <input
						type="text" class="form-control"
						placeholder="Insertar cédula"
						aria-describedby="basic-addon4" required id="cedulacl" >
				</div>
				<br>
				...
				<div class="input-group mb-3">
					<span class="input-group-text" style="width: 170px;" id="basic-addon1">Email</span> <input
						type="text" class="form-control"
						aria-describedby="basic-addon1" required id="email_cliente" disabled="disabled">
				</div>
				...
				<div class="input-group mb-3">
					<span class="input-group-text" style="width: 170px;" id="basic-addon3">Direccion</span>
					<input type="text" class="form-control"
						aria-describedby="basic-addon3" required id="direccion_cliente"  disabled="disabled">
				</div>

				<div class="input-group mb-3">
					<span class="input-group-text" style="width: 170px;" id="basic-addon4">Telefono</span> <input
						type="text" class="form-control"
				...
				<button type="button" class="btn btn-primary" onclick="enviar()"><i class="fas fa-search"></i> Buscar cliente</button><br><br>
		</div>
...
<center>
	...
	<script>
		function enviar() {
				...
				var cl=   document.getElementById("cedulacl").value;
				req.open('GET', 'http://localhost:8080/consultarcliente?cedula_cliente='+cl, false);
				req.send(null);
