...
<body>
	...
	<!-- contenido  -->
		...
		<h1 class="m-3"><i class="fas fa-clipboard-list"></i></i> Reportes</h1><br><br><br>
	<center>
			<div class="btn-group" role="group" aria-label="Basic mixed styles example" style="position: relative;">
				<button type="button" class="btn btn-warning m-5" style="width:300px;" onclick="window.location.href='/reporteusuarios.jsp'"><i class="fas fa-pen-alt"></i> Reporte Usuarios</button><br><br>
				<button type="button" class="btn btn-warning m-5" style="width:300px;" onclick="window.location.href='/reporteclientes.jsp'"><i class="fas fa-pen-alt"></i> Reporte Clientes</button><br><br>
				<button type="button" class="btn btn-warning m-5" style="width:300px;" onclick="window.location.href='/reporteventas.jsp'"><i class="fas fa-pen-alt"></i> Reporte Ventas</button><br><br>
			</div>
	</center>
