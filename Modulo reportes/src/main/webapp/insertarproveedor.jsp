...
<body>
	...
	<nav class="navbar navbar-light" style="background: rgb(210, 252, 246); width: 100%; height: 80px; margin: auto;">
		...
		<div class="container">
			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control"
						placeholder="Insertar la dirección"
				...
				<div class="input-group mb-3">
					<span class="input-group-text" style="width: 170px;" id="basic-addon4">Teléfono</span> <input
						type="text" class="form-control"
						placeholder="Insertar el teléfono"
			...
			<button type="button" class="btn btn-success" onclick="enviar()"><i class="fas fa-check"></i> Insertar nuevo proveedor</button>
		</div> <br> <br>
